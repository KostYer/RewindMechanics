...
namespace ReverseRelated.AnimRecording
{
    ...
    public class RawFrameRecorder: MonoBehaviour
    {
      ...
      //  private Dictionary<HumanBodyBones, Transform> ghostBoneMap;
        ...
        void Start()
        {
            ...
            {
                if (bone == HumanBodyBones.LastBone) continue; // skip sentinel
                var t = animatorGhost.GetBoneTransform(bone);
                if (t != null)
                {
                    ghostBoneMap[bone] = t;
                }
        ...
        public void OnRewindStart()
        {
          ...
          //  CreateAnimationClipFromFrames(recordedFrames);
            _isRewinding = true;
        }
